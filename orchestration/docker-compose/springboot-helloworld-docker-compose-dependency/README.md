...
##### Goal
The goal of this project is to present how to create **Hello World** application in **Java** programming language with usage **Spring Boot** framework and Docker Compose **dependency**. Docker Compose dependency automatically runs compose.yaml file before starting application.

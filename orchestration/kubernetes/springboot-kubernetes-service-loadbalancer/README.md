...
##### Goal
The goal of this project is to present how to create Kubernetes **Service** in type **LoadBalancer** for simple "Hello World" **Java** application with **Spring Boot** framework using **Kubernetes** tool. 


##### Details
**Kubernetes Service** is REST object connected with some specific Kubernetes Pod. In this example Kubernetes Service is in type **LoadBalancer** what means that it's **available outside Kubernetes** - for example in browser.
...
* **Download** source code and open any **Command Line** tool on **project's folder**. You can do it in following way:
    ...
    * Go to source code folder with `cd chrisblog-it-docker\orchestration\kubernetes\springboot-kubernetes-service-loadbalancer`

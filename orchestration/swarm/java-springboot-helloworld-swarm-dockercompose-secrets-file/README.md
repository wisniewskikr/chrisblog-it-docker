...
##### Goal
The goal of this project is to present how to use **secrets** created as **file** in **Java Spring Boot** application. This application uses **Docker Swarm** tool and **Docker Compose** and is already deployed as Docker Image in **Docker** public repository.
